...
for volume data.  An example control file (\texttt{Regrid\_NCEP.ctr}) for the NCEP 50-year Reanalysis is given 
...
\end{verbatim}
\normalsize
Line 1 specifies the projection of the computational grid, in this case, the LatLonFlag=1 indicating
...
This utility is used for probing the NWP files and returning the temperature as a function
of height.  
Usage:\\
